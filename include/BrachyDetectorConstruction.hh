...
public:
  ...
  void EnableHeterogeneity(G4bool enable);
...
private:
  ...
  G4bool fHeterogeneityEnabled;
  G4String fHeterogeneityMaterialName;
  G4ThreeVector fHeterogeneityHalfLengths;
  G4ThreeVector fHeterogeneityPosition;
  G4Box* fHeterogeneitySolid;
  G4LogicalVolume* fHeterogeneityLog;
