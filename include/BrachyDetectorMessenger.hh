...
private:
  ...
  G4UIdirectory*               fHeteroDir;
  G4UIcmdWithABool*            fHeteroEnableCmd;
  G4UIcmdWithAString*          fHeteroMaterialCmd;
  G4UIcmdWith3VectorAndUnit*   fHeteroSizeCmd;
  G4UIcmdWith3VectorAndUnit*   fHeteroPositionCmd;
};
#endif
